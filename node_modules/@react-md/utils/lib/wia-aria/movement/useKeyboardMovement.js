...
function useKeyboardMovement(_a) {
    ...
    var keys = react_1.useMemo(function () { return __spreadArray(__spreadArray(__spreadArray(__spreadArray([], utils_2.transformKeys(incrementKeys, "increment")), utils_2.transformKeys(decrementKeys, "decrement")), utils_2.transformKeys(jumpToFirstKeys, "first")), utils_2.transformKeys(jumpToLastKeys, "last")); }, [incrementKeys, decrementKeys, jumpToFirstKeys, jumpToLastKeys]);
    var itemRefs = react_1.useMemo(function () { return Array.from(items, function () { return ({ current: null }); }); }, [items]);
    var handleSearch = useKeyboardSearch_1.useKeyboardSearch({
        items: items,
        valueKey: valueKey,
