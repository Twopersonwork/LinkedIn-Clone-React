...
/// This function is used to quickly get one of the slider's theme values. This
/// is really just for the `rmd-slider-theme` mixin to provide some validation
/// that a correct style key is used, but might be useful in other cases.
///
/// @param {String} theme-style - One of the `$rmd-slider-theme-values` map keys
/// to get a value for.
/// @return {Color|String|Number} one of the slider's theme values.
...
/// This function is used to get one of the slider's theme variables as a CSS
/// Variable to be applied as a style attribute. By default, the CSS Variable
/// will have a fallback of the current `$rmd-slider-theme-values`
///
...
/// @return {String} one of the slider's theme values as a css variable.
