 ...
 */
export declare function useIndeterminateChecked<T extends string>(values: T[], defaultCheckedValues?: T[] | (() => T[]), onChange?: (checkedValues: T[]) => void): IndeterminateCheckedReturnValue<T>;
