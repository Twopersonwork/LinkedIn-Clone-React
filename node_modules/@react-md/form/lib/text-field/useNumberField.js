...
function useNumberField(_a) {
    ...
    var _h = react_1.useState(defaultValue), number = _h[0], setNumber = _h[1];
    var initial = react_1.useRef(number);
    var handleBlur = react_1.useCallback(function (event) {
        ...
        value = utils_1.withinRange(value, min, max);
    ...
    var handleChange = react_1.useCallback(function (event) {
        ...
        var input = event.currentTarget;
        input.checkValidity();
        var value = utils_1.withinRange(event.currentTarget.valueAsNumber, min, max);
    ...
    var _j = useTextField_1.useTextField({
        id: id,
    ...
    var updateNumber = react_1.useCallback(function (value) {
