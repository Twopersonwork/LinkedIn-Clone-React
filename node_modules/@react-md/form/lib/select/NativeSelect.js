 ...
 * full accessibility.
 */
exports.NativeSelect = react_1.forwardRef(function NativeSelect(_a, ref) {
    ...
    var _g = useFieldStates_1.useFieldStates({
        onBlur: propOnBlur,
        onFocus: propOnFocus,
    ...
    return (react_1.default.createElement(TextFieldContainer_1.TextFieldContainer, { style: style, className: classnames_1.default(container({
            multi: multiple,
        ...
        react_1.default.createElement(FloatingLabel_1.FloatingLabel, { style: labelStyle, className: classnames_1.default(block("label"), labelClassName), htmlFor: id, error: error, active: valued && focused, valued: valued, floating: valued || multiple, dense: dense, disabled: disabled }, label),
