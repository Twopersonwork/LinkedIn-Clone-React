 ...
 */
exports.Select = react_1.forwardRef(function Select(_a, forwardedRef) {
    ...
    var _z = useFocusState_1.useFocusState({ onBlur: onBlur, onFocus: onFocus }), focused = _z[0], handleFocus = _z[1], handleBlur = _z[2];
    var handleKeyDown = react_1.useCallback(function (event) {
        if (onKeyDown) {
            onKeyDown(event);
        }
        if (utils_1.tryToSubmitRelatedForm(event)) {
            return;
        }
        switch (event.key) {
            case " ":
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(TextFieldContainer_1.TextFieldContainer, __assign({}, props, { "aria-haspopup": "listbox", "aria-disabled": disabled || undefined, ref: refHandler, role: "button", dense: dense, tabIndex: disabled ? undefined : 0, label: !!label, onFocus: handleFocus, onBlur: handleBlur, onKeyDown: disabled ? undefined : handleKeyDown, onClick: disabled ? undefined : handleClick, theme: theme, error: error, active: focused || visible, inline: inline, disabled: disabled, underlineDirection: underlineDirection, isLeftAddon: isLeftAddon, isRightAddon: isRightAddon, rightChildren: rightChildren, className: classnames_1.default(block({ disabled: disabled }), className) }),
            react_1.default.createElement(FloatingLabel_1.FloatingLabel, { id: labelId, style: labelStyle, className: classnames_1.default(block("label"), labelClassName), htmlFor: id, error: error, active: valued && (focused || visible), valued: valued, floating: focused || valued || visible, dense: dense, disabled: disabled, component: "span" }, label),
