...
function useCollapse(collapsed, _a) {
    ...
    var _k = useTransition_1.useTransition({
        appear: appear,
        repaint: true,
        timeout: timeout,
        temporary: temporary,
        ...
        onEntering: function (node, isAppearing) {
            ...
            var _a = getElementSizing_1.getElementSizing(node), maxHeight = _a.maxHeight, paddingTop = _a.paddingTop, paddingBottom = _a.paddingBottom;
            var defaultedTimeout = getTimeout_1.getTimeout(timeout, isAppearing);
        ...
        onExit: function (node) {
            ...
            setStyle({
                ...
                paddingTop: paddingTop,
                paddingBottom: paddingBottom,
                transitionDuration: getTimeout_1.getTimeout(timeout, false).exit + "ms",
            });
        },
    ...
    var collapsable = react_1.useMemo(function () { return Object.values(getTimeout_1.getTimeout(timeout, false)).some(function (v) { return v !== 0; }); }, [timeout]);
