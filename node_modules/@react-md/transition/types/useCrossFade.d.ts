 ...
 */
export declare function useCrossFade<E extends HTMLElement = HTMLDivElement>({ appear, temporary, transitionIn, className, onEnter, onEntering, onEntered, onExit, onExiting, onExited, }?: CrossFadeOptions<E>): CSSTransitionReturnValue<E>;
