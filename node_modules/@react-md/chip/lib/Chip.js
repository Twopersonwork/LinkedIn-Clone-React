 ...
 */
exports.Chip = react_1.forwardRef(function Chip(_a, ref) {
    var _b;
    ...
    return (react_1.default.createElement(Component, __assign({}, (noninteractable ? {} : buttonProps), props, handlers, { ref: ref, className: classnames_1.default(block((_b = {},
            _b[theme] = true,
